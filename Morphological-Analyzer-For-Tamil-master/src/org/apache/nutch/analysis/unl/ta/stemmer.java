...
public class stemmer {
        ...
        try {
            ...
            for (int i = 0; i < listOfFiles.length; i++) {
                ...
                if (listOfFiles[i].isFile()) {
                    fileno++;
            Reader reader = new InputStreamReader(new FileInputStream(new File("./Token/input" + fileno + ".txt")), "UTF-8");
            BufferedReader inbuff = new BufferedReader(reader);
            Writer writer = new OutputStreamWriter(new FileOutputStream(new File("./MA/maout" + (fileno) + ".txt")), "UTF-8");
            BufferedWriter outbuff = new BufferedWriter(writer);
    ...
    public static String getRoot(String word) {
        //System.out.print(getRoot(analyse(word, analysePart)));
    ...
    public ArrayList onlineDictAnalyser(String input) {
        ...
        if (!input.contains("<Error>")) {
            ...
            System.out.print(getRootWord(input));
